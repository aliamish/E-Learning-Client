...
const CourseData: FC<Props> = ({
  ...
  setActive,
    ...
    const handleBeneFitChange = (index: number, value: any) => {
        const updatedDenefits = [...benefits];
         updatedDenefits[index].title = value;
         setBenefits(updatedDenefits);
    };
     ...
     <div>
        ...
        <br />
           {benefits.map((benefit: any, index: number) => (
            ...
            key={index}
            name="Benefit"
            placeholder="You will be able to bulid a full stack LMS platform..."
            required
